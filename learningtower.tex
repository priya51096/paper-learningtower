...
and statistical analyses. In addition, we address a few interesting
research questions and present the analysis for the gender gap noticed
in these students', the effect of different socioeconomic factors on the
students' performance, and we go further to study the Australia's PISA
scores.
}
