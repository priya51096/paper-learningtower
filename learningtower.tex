...
wrapped within \CRANpkg{ggplot2} \citep{ggplot2}, the intearctive
...
wrapped within \CRANpkg{ggplot2} \citep{ggplot2}, we further plot this
with the help of \CRANpkg{viridis} \citep{viridis} and
