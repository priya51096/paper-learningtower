...
wrapped within \CRANpkg{ggplot2} \citep{ggplot2}, \CRANpkg{plotly}
...
\CRANpkg{learningtower} package is comprises scores of 15-year-olds from
...
wrapped within \CRANpkg{ggplot2} \citep{ggplot2}, \CRANpkg{viridis}
\citep{viridis} and \CRANpkg{patchwork} \citep{patchwork}
...
since 2000, the developers of the \CRANpkg{learningtower} package, feel
...
\CRANpkg{gganimate} \citep{gganimate} the that explains how performance
