...
```{r tv-plot, fig.cap ="TV Plot", fig.height=21, fig.width=12, fig.pos = "H", out.width="100%", layout="l-body"}
tv_plot
```
...
```{r book-plot, fig.cap ="Book Plot", fig.height=21, fig.width=12, fig.pos = "H", out.width="100%", layout="l-body"}
book_plot
```
...
```{r compint-plot, fig.cap ="Qualification Plots",  fig.pos = "H", out.width="100%", layout="l-body"}
