...
```{r anim-plot, fig.cap = "Animation of math and reading scores over time.", eval = knitr::is_html_output(), fig.width = 10, fig.height = 10, out.width="100%", layout="l-body-outset"}
